...
[assembly: PreApplicationStartMethod(typeof(SwaggerConfigWx), "Register")]
namespace $rootnamespace$
{
	public class SwaggerConfigWx
	{
		...
		protected static List<string> GetAllXmlFilePaths()
		{
			string path = string.Empty;
			path = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "bin");

			var paths = new List<string>();
			foreach (string file in Directory.GetFiles(path).Where(m => ".xml".Equals(Path.GetExtension(m))))
			{
